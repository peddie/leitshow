...
/* Filtering for the adaptive decorrelator */
#define NUM_BOUNDS (NUM_CHANNELS - 1)

#define CORR_UPDATE_EVERY 10

#define CORR_FILTER_CUTOFF_HZ 10
#define CORR_FILTER_SAMPLE_TIME (((float) BUFSIZE) / ((float) AUDIO_SAMPLE_RATE))
#define CORR_FILTER_CONSTANT ((BIN_FILTER_SAMPLE_TIME * 6.283185307179586) / (1 + (CORR_FILTER_SAMPLE_TIME * 6.283185307179586)))

#define CORR_OPT_RANGE 3

#define CORR_VARIANCE_WEIGHT 1
#define CORR_XCORR_WEIGHT 0.01
#define CORR_MIN_WEIGHT 1
#define CORR_NARROW_WEIGHT 10
